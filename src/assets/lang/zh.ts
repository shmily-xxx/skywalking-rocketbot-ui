...
const m = {
  ...
  delete: '删除',
  tip: '提示',
  deleteMsg: '确定删除该告警规则吗？',
  ruleName: '规则名称',
  inputRuleName: '请输入规则名称',
  inputRuleNameMsg: '支持中英文、数字及-_.',
  resourceType: '资源类型',
  resourceRange: '资源范围',
  allServer: '全部服务',
  alarmRule: '告警规则',
  ...
  userGroup: '用户组',
  serviceSla: '服务可用率',
  serviceRespTime: '服务响应时间(平均)',
  servicePercentilep50: '服务响应时间(p50)',
  servicePercentilep75: '服务响应时间(p75)',
  servicePercentilep90: '服务响应时间(p90)',
  servicePercentilep95: '服务响应时间(p95)',
  servicePercentilep99: '服务响应时间(p99)',
  notificationObjectMsg: '通知对象不能为空',
  fullName: '姓名',
  inputUserGroupName: '请输入用户组名称',
  inputUserName: '请输入用户名',
  inputUserOrFullName: '请输入用户名或姓名',
  resErrorMsg: '当前网络不佳，无法正常提供服务，请稍后重试，给您带来不便，敬请谅解！',
  reLoadMsg: '登录已过期，请重新登录',
  forbiddenErrorMsg: '无访问权限',
  res404ErrorMsg: '当前服务异常，请联系管理员！',
  tenantId: '租户ID',
};
