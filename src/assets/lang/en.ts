...
const m = {
  ...
  addAlarmRule: 'New Rule',
  editAlarmRule: 'Edit Rule',
  operate: 'Operate',
  delete: 'Delete',
  tip: 'Tip',
  deleteMsg: 'Are you sure to delete this alert rule?',
  ruleName: 'Name',
  inputRuleName: 'Enter the rule name',
  inputRuleNameMsg: 'Support letters, numbers and -_.',
  resourceType: 'Scope',
  resourceRange: 'Range',
  ...
  have: 'has',
  frequency: 'times',
  alarmSilence: 'Silence',
  ruleAlarmSilenceMsg: 'Keeps silence after alarm triggered.',
  notificationMethod: 'Action',
  notificationObject: 'Notification',
  mail: 'Email',
  includeUsers: 'Users Included',
  shortMessage: 'Message',
  stationMail: 'In-site Notification',
  mobilePhone: 'mobilePhone',
  user: 'User',
  userGroup: 'User Group',
  serviceSla: 'ServiceSLA',
  serviceRespTime: 'ServiceRespTime(average)',
  servicePercentilep50: 'ServiceRespTime(p50)',
  servicePercentilep75: 'ServiceRespTime(p75)',
  servicePercentilep90: 'ServiceRespTime(p90)',
  servicePercentilep95: 'ServiceRespTime(p95)',
  servicePercentilep99: 'ServiceRespTime(p99)',
  notificationObjectMsg: '通知对象不能为空',
  fullName: 'name',
  inputUserGroupName: 'Enter the user group',
  inputUserName: '请输入用户名',
  inputUserOrFullName: 'Enter the name',
  resErrorMsg: 'Network connection timed out, please try again later!',
  reLoadMsg: 'Login has expired, please log in again',
  forbiddenErrorMsg: 'No Permission',
  res404ErrorMsg: 'Internal Server Error!',
  tenantId: 'Tenant Id',
};
